<template>
  <div class="flex flex-col items-center justify-center max-w-2xl px-4 pt-16 mx-auto sm:max-w-xl md:max-w-2xl lg:pt-32 md:px-8">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
        <span class="relative inline-block">
          ...
          <span class="relative">{{ heroPicture.title }}</span>
        </span>
    ...
    <div class="flex items-center mt-6 -mx-2 mb-8">
      <a
        class="mx-2"
        :href="heroPicture.url[0]"
        :aria-label="heroPicture.label[0]"
      >
        <svg
          viewBox="0 0 30 30"
          fill="currentColor"
      ...
      <a
        class="mx-2"
        :href="heroPicture.url[1]"
        :aria-label="heroPicture.label[1]"
      >
        <svg
          class="w-6 h-6 animate-bounce text-gray-700 fill-currenthover:text-gray-600"
          xmlns=""
          viewBox="0 0 512 512"
        >
      ...
      <a
        class="mx-2"
        :href="heroPicture.url[2]"
        :aria-label="heroPicture.label[2]"
      >
        <svg
          class="w-6 h-6 animate-bounce text-gray-700 fill-currenthover:text-gray-600 "
          xmlns=""
...
import { IPictureHero } from '../../types'
export default {
  props: {
    heroPicture: { type: Object as PropType<IPictureHero>, required: true },
  },
}
</script>
